...
//////////////////////////////////////////////////////////////////////////////
/**
* Create a new instance of class vectorTile
*
* @class geo.vectorTile
* @extends geo.fileReader
* @returns {geo.vectorTile}
*/
//////////////////////////////////////////////////////////////////////////////
var vectorTile = function (arg) {
  'use strict';
  if (!(this instanceof vectorTile)) {
    return new vectorTile(arg);
  }
  ...
  this._readObject = function (file, done) {
    var object;
  ...
  this.drawTile = function (bounds, file, done) {
    var tileIndex = geojsonvt(file);
    var tile = tileIndex.getTile(1, 0, 0);
    tile.type = 'FeatureCollection';
    tile.features.map(function (f) {
      f.type = 'Feature';
      var geometry = f.geometry;
      f.geometry = {};
      f.geometry.type = 'Polygon';
      f.geometry.coordinates = geometry;
      return f;
    });
    m_this._readObject(tile, done);
  };

  this.read = function (file, map, done) {
    ...
    map.geoOn(geo.event.pan, () => {
      this.drawTile(map.bounds(), file, _done);
    });
  };
};

inherit(vectorTile, fileReader);
registerFileReader('vectorTile', vectorTile);
