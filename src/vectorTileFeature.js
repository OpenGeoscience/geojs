...
//////////////////////////////////////////////////////////////////////////////
/**
 * Create a new instance of class vectorTileFeature
 *
 * @class geo.vectorTileFeature
 * @extends geo.feature
 * @returns {geo.vectorTileFeature}
 */
//////////////////////////////////////////////////////////////////////////////
var vectorTileFeature = function (arg) {
  'use strict';
  if (!(this instanceof vectorTileFeature)) {
    return new vectorTileFeature(arg);
  }
...
inherit(vectorTileFeature, feature);
