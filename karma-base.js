    ...
    customLaunchers: {
      ...
      FirefoxHeadlessTouch: {
        ...
        prefs: {
          ...
          /* By default, Firefox makes many connections when it starts to
           * sites like mozilla.org, yahoo.com, google.com, etc.  This limits
           * these connections (but doesn't eliminate them completely,
           * especially when accessing the 2d canvas).  See
